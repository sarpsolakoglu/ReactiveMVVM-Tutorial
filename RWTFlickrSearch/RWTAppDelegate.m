...
@property (strong, nonatomic) RWTViewModelServices *viewModelServices;
...
- (UIViewController *)createInitialViewController {
    self.viewModelServices = [[RWTViewModelServices alloc] initWithNavigationController:self.navigationController];
